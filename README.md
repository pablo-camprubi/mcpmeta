...
Want to deploy your own instance? You can easily deploy this MCP server to cloud platforms:

- **[Quick Deploy Guide](QUICK_DEPLOY.md)** - Deploy to Railway or Render in under 5 minutes
- **[Full Deployment Guide](DEPLOYMENT.md)** - Comprehensive guide for Railway, Render, and Fly.io
- **[Streamable HTTP Setup](STREAMABLE_HTTP_SETUP.md)** - Detailed HTTP transport configuration
- **[AnalyticsAds Integration](examples/README_ANALYTICSADS_INTEGRATION.md)** - Examples for accessing from your desktop apps

Meta Ads MCP supports streamable HTTP transport, allowing you to run it as a standalone HTTP API accessible from any application, including your desktop analyticsads repository.
